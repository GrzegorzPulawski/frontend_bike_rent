            ...
            <Container>
                <Card className="shadow-sm mb-4" style={{ border: 'none' }}>
                    <Card.Body style={{ backgroundColor: '#343a40', color: 'white' }}>
                        <h2 className="mb-0">Lista utworzonych wypożyczeń</h2>
                    </Card.Body>
                </Card>
                        ...
                        <Row className="align-items-center">
                            <Col md={4}>
                                <Form.Group controlId="datePicker">
                                    <Form.Label style={{ fontWeight: '500', color: '#343a40' }}>Wybierz datę:</Form.Label>
                                    <Form.Control
                                        type="date"
                                        value={selectedDate}
                        ...
                        <Card className="shadow-sm mb-3">
                            <Card.Body className="p-0">
                                ...
                                {filteredRentings.length > 0 ? (
                                    ...
                                    <Row className="py-4">
                                        <Col className="text-center text-muted">Brak utworzonych wypożyczeń na tę datę.</Col>
                                    </Row>
                                )}
                            </Card.Body>
                        </Card>
                                ...
                                <Card.Body className="py-2" style={{ backgroundColor: '#f8f9fa' }}>
                                    <Row className="fw-bold text-center">
                                        <Col xs={8} className="text-end" style={{ color: '#343a40' }}>
                                            Ilość utworzonych wypożyczeń w ciągu dnia:
                                        </Col>
